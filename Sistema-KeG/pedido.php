...
<td>
<select name="idServicos">
<option value="">Servi&ccedil;o</option>
<?php
$conexao = mysql_connect("localhost","root","");
mysql_select_db("bd_keg",$conexao);
$sql = "SELECT idServicos, descricao FROM Servicos order by idServicos";
$row = mysql_query($sql,$conexao) or die('Erro ao selecionar o servico: ' .mysql_error());
